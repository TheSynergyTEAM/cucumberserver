...
@Getter
@NoArgsConstructor
public class FavListCreateRequestDto {
    ...
    @Builder
    public FavListCreateRequestDto(Member member, String title, Categories categories, int price, String spec, Photo photo){
        this.member = member;
        this.title = title;
    ...
    public FavouriteList toEntity(){
        return FavouriteList.builder()
                .member(member)
                .title(title)
